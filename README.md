...
- 在 Home 或 Materials 中打开素材
- 导入自己的视频、音频、封面和 transcript
- 用语音或输入抓取词伙
- 用语音或输入记录中文理解
- 分析词伙含义、使用范围和理解准确度
- 将词伙保存到 Phrase，并继续造句
...
Materials 使用方形封面图库；右上角编辑按钮可以开启每个素材的编辑和删除入口。Home 和 Materials 中的素材封面都会直接进入对应素材详情。

## 文件

- `index.html`：页面结构
- `styles.css`：响应式界面、移动端三列素材图库和磨砂玻璃视觉
